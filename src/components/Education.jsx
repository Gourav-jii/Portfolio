...
const Education = () => {
  const educationData = [
    ...
    },
    {
      ...
      grade: '90.80%',
      accentFrom: 'from-neon-pink',
      accentTo: 'to-neon-cyan',
      hoverBorder: 'hover:border-neon-pink/30 hover:shadow-[0_0_20px_rgba(254,8,181,0.1)]',
      iconColor: 'text-neon-pink',
      iconBg: 'bg-neon-pink/10 border-neon-pink/20',
      tagStyle: 'text-neon-pink bg-neon-pink/5 border-neon-pink/15',
    },
  ];
